...
CREATE TABLE `special_price_date` (
  ...
  `special_date_from` datetime NOT NULL,
   `special_date_end` datetime NOT NULL,	
  PRIMARY KEY (`pricing_id`,`special_date_from`, `special_date_end`),
